...
```{r}
windows()
tm_shape(Capa.Areas) + tm_borders() +
tm_shape(union.buffer) + tm_fill(col = "blue", alpha = 0.4) + tm_borders(col = "blue") +
tm_shape(data.points) + tm_dots(col = "red")
```
